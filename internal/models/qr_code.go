...
var QRCodeStatuses = []QRCodeStatus{
	QRCodeStatusAvailable,
	QRCodeStatusAssociated,
	QRCodeStatusDamaged,
	QRCodeStatusLost,
}

func (s QRCodeStatus) IsValid() bool {
	return slices.Contains(QRCodeStatuses, s)
}
...
type QRCode struct {
	...
	Batch  *QRCodeBatch `json:"batch,omitempty" gorm:"foreignKey:BatchID"`
}
